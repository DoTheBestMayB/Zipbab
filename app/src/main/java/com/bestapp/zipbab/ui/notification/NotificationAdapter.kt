...
class NotificationAdapter :
    ...
    companion object {
        val diffUtil = object : DiffUtil.ItemCallback<NotificationTypeResponse>() {
            override fun areItemsTheSame(
                oldItem: NotificationTypeResponse,
                newItem: NotificationTypeResponse
            ): Boolean {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return when (viewType) {
            TYPE_MAIN -> {
                val binding = ViewholderMainNotificationBinding.inflate(
            ...
            TYPE_USER -> {
                val binding = ViewholderUserNotificationBinding.inflate(
                    LayoutInflater.from(parent.context),
                    parent,
                    false
                )
    ...
    class ViewHolderMain(private val binding: ViewholderMainNotificationBinding) :
    ...
    class ViewHolderUser(private val binding: ViewholderUserNotificationBinding) :
        RecyclerView.ViewHolder(binding.root) {
